...
const App: React.FC = () => {
  ...
  if (authLoading) return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="text-white text-[10px] uppercase tracking-[0.3em] font-black animate-pulse italic">Iniciando Acervo</div>
    </div>
  );
  ...
  return (
    <div className={`min-h-screen flex flex-col lg:flex-row ${mainClass} selection:bg-white selection:text-black`}>
      ...
      <aside className={`hidden lg:flex w-72 border-r flex-shrink-0 flex-col no-print ${sidebarClass}`}>
        <div className="p-10">
          <h1 className="text-3xl font-black tracking-tighter italic">ACERVO</h1>
      ...
      <main className="flex-1 overflow-y-auto p-5 md:p-10 pb-32 lg:pb-10">
        ...
        {/* Categories e Settings seguem estilo refinado similar */}
                 ...
                 {activeView === 'settings' && (
                    <div className="space-y-4">
                        ...
                        <Card className="p-8 flex justify-between items-center border-zinc-800">
                            <div>
                                <h3 className="font-black uppercase text-sm tracking-widest text-zinc-400">Backup</h3>
                                <p className="text-xs text-zinc-600 mt-1">Exportar base de dados JSON.</p>
                            </div>
                            <Button variant="outline" className="border-zinc-800">Exportar</Button>
                        </Card>
      ...
      {/* REMAINDER OF MODALS - Same logic, refreshed UI.tsx handles the visual lift */}
